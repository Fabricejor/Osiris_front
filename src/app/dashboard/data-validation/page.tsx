...
const STATUS_FILTERS: { value: FolderStatus | 'all'; label: string; color: string }[] = [
  ...
  { value: 'validated', label: 'Validated', color: 'bg-emerald-100 text-emerald-700' },
  { value: 'rejected', label: 'Rejected', color: 'bg-red-100 text-red-700' },
  { value: 'anomaly', label: 'Anomaly', color: 'bg-blue-100 text-blue-700' },
];
      ...
      <div className="shrink-0 flex flex-col sm:flex-row items-start sm:items-center gap-3">
        ...
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-700 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50 transition-all"
          />
        </div>
        ...
        {/* View Toggle */}
        <div className="ml-auto flex items-center bg-gray-100 p-0.5 rounded-lg">
          <button
            onClick={() => setViewMode('folders')}
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium transition-colors ${
              viewMode === 'folders' ? 'bg-white text-gray-800 shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            <LayoutGrid className="w-4 h-4" /> Folders
          </button>
          <button
            onClick={() => setViewMode('details')}
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium transition-colors ${
              viewMode === 'details' ? 'bg-white text-gray-800 shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
